...
import 'package:edex_365_getx/features/student_panel/model/transaction_history_response_model.dart';
...
class TransactionHistoryService {
  ...
  Future<List<TransactionHistoryResponseModel>> getSpentHistory(String userId) async {
    return _fetchTransactions("/api/StudentWallet/s/StudentAllCostTransaction?userId=$userId");
  }
