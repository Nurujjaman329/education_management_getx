...
class AllBanglaVersionClassService {
  final Dio client = Dio();

  Future<List<AllBanglaVersionClassResponseModel>> fetchClasses() async {
    try {
      ...
      switch (response.statusCode) {
        case 200:
          ...
          return data.map((e) => AllBanglaVersionClassResponseModel.fromJson(e)).toList();
        case 404:
          throw AuthException();
        default:
